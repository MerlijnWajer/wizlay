...
# $Header: /var/cvsroot/gentoo-x86/dev-lang/fpc/fpc-2.6.0.ebuild,v 1.6 2012/01/01 18:43:24 Wizzup Exp $
...
SRC_URI="mirror://sourceforge/freepascal/fpcbuild-${PV}.tar.gz
	amd64? ( mirror://sourceforge/freepascal/fpc-2.6.0.x86_64-linux.tar )
	ppc? ( mirror://sourceforge/freepascal/fpc-2.6.0.powerpc-linux.tar )
	sparc? ( mirror://sourceforge/freepascal/fpc-2.2.4.sparc-linux.tar )
	x86? ( mirror://sourceforge/freepascal/fpc-2.6.0.i386-linux.tar )"
SLOT="0"
...
src_unpack() {
	case ${ARCH} in
	amd64)	FPC_ARCH="x86_64"  PV_BIN=2.6.0 ;;
	ppc)	FPC_ARCH="powerpc" PV_BIN=2.6.0 ;;
	sparc)	FPC_ARCH="sparc"   PV_BIN=2.6.0 ;;
	x86)	FPC_ARCH="i386"    PV_BIN=2.6.0 ;;
