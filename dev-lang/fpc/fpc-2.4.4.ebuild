...
# $Header: /var/cvsroot/gentoo-x86/dev-lang/fpc/fpc-2.4.2.ebuild,v 1.5 2011/02/12 18:43:24 armin76 Exp $
...
src_unpack() {
	case ${ARCH} in
	amd64)	FPC_ARCH="x86_64"  PV_BIN=2.4.4 ;;
	ppc)	FPC_ARCH="powerpc" PV_BIN=2.4.4 ;;
	sparc)	FPC_ARCH="sparc"   PV_BIN=2.2.4 ;;
	x86)	FPC_ARCH="i386"    PV_BIN=2.4.4 ;;
